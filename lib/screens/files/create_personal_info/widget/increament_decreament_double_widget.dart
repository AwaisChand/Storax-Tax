...
class IncrementDecrementFileDouble extends StatefulWidget {
  final String labelText;
  final double initialValue;
  final ValueChanged<double> onChanged;
  final double step;

  const IncrementDecrementFileDouble({
    super.key,
  ...
  @override
  _IncrementDecrementFileDoubleState createState() =>
      _IncrementDecrementFileDoubleState();
}

class _IncrementDecrementFileDoubleState
    extends State<IncrementDecrementFileDouble> {
  ...
  @override
  void didUpdateWidget(covariant IncrementDecrementFileDouble oldWidget) {
