...
class IncrementDecrementInputField extends StatefulWidget {
  ...
  const IncrementDecrementInputField({
    super.key,
  ...
  @override
  _IncrementDecrementInputFieldState createState() =>
      _IncrementDecrementInputFieldState();
}

class _IncrementDecrementInputFieldState
    extends State<IncrementDecrementInputField> {
  ...
  @override
  void didUpdateWidget(covariant IncrementDecrementInputField oldWidget) {
