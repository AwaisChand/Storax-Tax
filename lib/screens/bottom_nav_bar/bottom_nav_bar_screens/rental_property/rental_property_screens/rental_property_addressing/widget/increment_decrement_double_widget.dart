...
class IncrementDecrementFieldDouble extends StatefulWidget {
  final String labelText;
  final double initialValue;
  final ValueChanged<double> onChanged;
  final double step;

  const IncrementDecrementFieldDouble({
    super.key,
  ...
  @override
  _IncrementDecrementFieldDoubleState createState() =>
      _IncrementDecrementFieldDoubleState();
}

class _IncrementDecrementFieldDoubleState
    extends State<IncrementDecrementFieldDouble> {
  ...
  @override
  void didUpdateWidget(covariant IncrementDecrementFieldDouble oldWidget) {
