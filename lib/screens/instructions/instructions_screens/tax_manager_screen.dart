...
class TaxManagerScreen extends StatefulWidget {
  const TaxManagerScreen({super.key});

  @override
  State<TaxManagerScreen> createState() =>
      _TaxManagerScreenState();
}

class _TaxManagerScreenState extends State<TaxManagerScreen> {
  @override
  void initState() {
    super.initState();
      ...
      builder: (context, getInstructions, _) {
        ...
        return Scaffold(
          ...
          appBar: CustomAppBar(
            text1: "Instructions",
            text2:
            AppLocalizations.of(context)!.translate("tmTitleText") ?? '',
            drawerTapped: () {
