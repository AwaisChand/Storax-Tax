...
class GasReceiptManagerScreen extends StatefulWidget {
  const GasReceiptManagerScreen({super.key});

  @override
  State<GasReceiptManagerScreen> createState() =>
      _GasReceiptManagerScreenState();
}

class _GasReceiptManagerScreenState extends State<GasReceiptManagerScreen> {
  @override
  void initState() {
    super.initState();
      ...
      builder: (context, getInstructions, _) {
        ...
        return Scaffold(
          ...
          appBar: CustomAppBar(
            text1: "Instructions",
            text2:
                AppLocalizations.of(context)!.translate("gasTitleText") ?? '',
            drawerTapped: () {
                            ...
                            children: [
                              ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final instruction =
                                      getInstructions.instructions[index];
