class TaxProfessionalPlansModel {
  int? status;
  String? success;
  List<Plans>? plans;

  TaxProfessionalPlansModel({this.status, this.success, this.plans});

  TaxProfessionalPlansModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Features {
  ...
  Features({this.name, this.included, this.translationKey, this.clientsLimit});
  ...
  Map<String, dynamic> toJson() {
    ...
    data['translation_key'] = translationKey;
