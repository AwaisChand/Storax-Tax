class GetPersonalInfoModel {
  int? status;
  String? success;
  List<PersonalInfoList>? data;

  GetPersonalInfoModel({this.status, this.success, this.data});
  ...
  GetPersonalInfoModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(PersonalInfoList.fromJson(v));
      });
    }
  }
...
class PersonalInfoList {
  ...
  PersonalInfoList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    year = json['year'];
    ...
    ownForeignProperty = json['own_foreign_property'] != null
        ? json['own_foreign_property'] == 1
        : null;
